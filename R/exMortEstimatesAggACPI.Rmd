...
here::i_am('R/exMortEstimatesAggAltCIFinal.Rmd')
...
simDataMonthly <- simDataMonthly %>%
  ...
  ungroup() %>%
  left_join(ACYearlyData,by=c('FIPSCode','csCode')) %>%
...
excDeaths %>% write_csv(here::here(outDir,'exMortEstimatesAggACPI.csv'))
