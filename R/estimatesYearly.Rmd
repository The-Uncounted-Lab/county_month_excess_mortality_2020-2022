...
simDataMonthly <- ACData %>%
  ...
  ungroup() %>%
  mutate(deathsCensored = if_else(year>2019,NA_integer_,deaths)) %>%
...
simulationsFIPSMonthly <- simulationsFIPSMonthly %>%
  ...
  summarize(expDeathsLow = quantile(expDeaths,probs=c(0.05)),
            ...
            nonCOVIDexcessLow = quantile(nonCOVIDexcess,probs=c(0.05)),
            nonCOVIDexcessMed = quantile(nonCOVIDexcess,probs=c(0.5)),
            nonCOVIDexcessUp = quantile(nonCOVIDexcess,probs=c(0.95)),
...
finalSimsFIPS <- simulationsFIPSMonthly  %>%
  ...
  mutate(deathsDiffPct = if_else(is.na(deathsDiffPct),0,deathsDiffPct),
         ...
         nonCOVIDexcessMed = if_else(deathsDiffPct>diffTreshold,nonCOVIDexcessMedSC,nonCOVIDexcessMed),
         nonCOVIDexcessLow = if_else(deathsDiffPct>diffTreshold,nonCOVIDexcessLowSC,nonCOVIDexcessLow),
         nonCOVIDexcessUp = if_else(deathsDiffPct>diffTreshold,nonCOVIDexcessUpSC,nonCOVIDexcessUp),
  ...
  select(csCode,FIPSCode,year,
         ...
         imputedCOVIDDeaths,
         nonCOVIDexcessLow,nonCOVIDexcessMed,nonCOVIDexcessUp,
         COVIDExcRatio)
...
excDeaths2020 <- finalSimsFIPS %>%
  ...
  select(FIPSCode,csCode,
         ...
         nonCOVIDexcessLow,nonCOVIDexcessMed,nonCOVIDexcessUp,
         COVIDExcRatio) %>%
  mutate(nonCOVIDexcessLow = nonCOVIDexcessLow/adjF2020,
         nonCOVIDexcessMed = nonCOVIDexcessMed/adjF2020,
         nonCOVIDexcessUp = nonCOVIDexcessUp/adjF2020) %>%
...
excDeaths2022 <- finalSimsFIPS %>%
  ...
  select(FIPSCode,csCode,
         ...
         nonCOVIDexcessLow,nonCOVIDexcessMed,nonCOVIDexcessUp,
         COVIDExcRatio) %>%
  mutate(nonCOVIDexcessLow = nonCOVIDexcessLow/adjF2022,
         nonCOVIDexcessMed = nonCOVIDexcessMed/adjF2022,
         nonCOVIDexcessUp = nonCOVIDexcessUp/adjF2022) %>%
