...
exMortData <- read_csv(here::here(outDir,'exMortEstimatesACPI.csv'))
...
pdf(here::here('figures','fig1_2020.pdf'),width=10,height = 11)

fig1Map2020/fig1Bars2020 + plot_layout(heights = c(3, 1)) + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig1_2020.png'), width = 2500, height = 2500, res = 300, pointsize=4)
...
pdf(here::here('figures','fig1_2021.pdf'),width=10,height = 11)

fig1Map2021/fig1Bars2021 + plot_layout(heights = c(3, 1)) + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig1_2021.png'), width = 2500, height = 2500, res = 300, pointsize=4)
...
png(here::here('figures','fig1.png'), width = 4000, height = 2500, res = 300, pointsize=4)

fig1Maps / fig1Bars + plot_layout(heights = c(3,1)) + plot_annotation(tag_levels = 'A')
...
pdf(here::here('figures','fig2_2020.pdf'),width=10,height = 11)

fig2Map2020/fig2Bars2020 + plot_layout(heights = c(3, 1)) + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig2_2020.png'), width = 2500, height = 2500, res = 300, pointsize=4)
...
pdf(here::here('figures','fig2_2021.pdf'),width=10,height = 11)

fig2Map2021/fig2Bars2021 + plot_layout(heights = c(3, 1)) + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig2_2021.png'), width = 2500, height = 2500, res = 300, pointsize=4)
...
png(here::here('figures','fig2.png'), width = 4000, height = 2500, res = 300, pointsize=4)

fig2Maps / fig2Bars + plot_layout(heights = c(3,1)) + plot_annotation(tag_levels = 'A')
...
pdf(here::here('figures','fig3_2020.pdf'),width=10,height = 14)
...
png(here::here('figures','fig3_2020.png'), width = 2000, height = 2500, res = 300, pointsize=4)
...
pdf(here::here('figures','fig3_2021.pdf'),width=10,height = 14)
...
png(here::here('figures','fig3_2021.png'), width = 2000, height = 2500, res = 300, pointsize=4)
...
png(here::here('figures','fig3.png'), width = 3000, height = 3500, res = 300, pointsize=4)
...
fig4BarsTop2020 <- exMortData %>%
  filter(pop2020 > popCutoff) %>%
  slice_max(order_by = nonCovidExcCDRMed2020, n = nBars) %>%
  arrange(desc(nonCovidExcCDRMed2020)) %>%
  select(countyStateName,nonCovidExcCDRMed2020,
         nonCovidExcCDRLow2020,nonCovidExcCDRUp2020) %>%
  ggplot() +
  geom_point(mapping=aes(x=reorder(countyStateName,(nonCovidExcCDRMed2020)),
                         y = nonCovidExcCDRMed2020*100),
             color = brewer.pal(5, 'Blues')[5]) + 
  geom_errorbar(mapping=aes(x=reorder(countyStateName,(nonCovidExcCDRMed2020)),
                            ymin = nonCovidExcCDRLow2020*100, 
                            ymax = nonCovidExcCDRUp2020*100),
                width = 0.3, size = 0.8, color = brewer.pal(5, 'Blues')[5]) +
  scale_y_continuous(labels = comma_format(big.mark = ',',decimal.mark = '.')) + 
  coord_flip(ylim=c(0,300)) +
  labs(x = "", 
       y = "Excess Death Rate Net of COVID (Per 100,000 Person-Years)",
       title = "Highest Excess Death Rate Net of COVID (2020)",
       fill='') +
  theme_minimal()

```

```{r, echo=FALSE, warning=F, message=F, fig.width=12, eval=F}

## Fig 4 Bars Bottom 2020

popCutoff <- 100000
nBars <- 20

fig4BarsBottom2020 <- exMortData %>%
  filter(pop2020 > popCutoff) %>%
  slice_min(order_by = nonCovidExcCDRMed2020, n = nBars) %>%
  arrange(desc(nonCovidExcCDRMed2020)) %>%
  select(countyStateName,nonCovidExcCDRMed2020,
         nonCovidExcCDRLow2020,nonCovidExcCDRUp2020) %>%
  ggplot() +
  ...
  geom_errorbar(mapping=aes(x=reorder(countyStateName,(nonCovidExcCDRMed2020)),
                ...
                width = 0.3, size = 0.8, color = brewer.pal(5, 'Blues')[5]) +
  scale_y_continuous(labels = comma_format(big.mark = ',',decimal.mark = '.')) + 
  coord_flip(ylim=c(-200,50)) +
  labs(x = "", 
       y = "Excess Death Rate Net of COVID (Per 100,000 Person-Years)",
       title = "Lowest Excess Death Rate Net of COVID (2020)",
       fill='') +
  theme_minimal()
...
fig4BarsTop2021 <- exMortData %>%
  filter(pop2021 > popCutoff) %>%
  slice_max(order_by = nonCovidExcCDRMed2021, n = nBars) %>%
  arrange(desc(nonCovidExcCDRMed2021)) %>%
  select(countyStateName,nonCovidExcCDRMed2021,
         nonCovidExcCDRLow2021,nonCovidExcCDRUp2021) %>%
  ggplot() +
  geom_point(mapping=aes(x=reorder(countyStateName,(nonCovidExcCDRMed2021)),
                         y = nonCovidExcCDRMed2021*100),
             color = brewer.pal(5, 'Blues')[5]) + 
  geom_errorbar(mapping=aes(x=reorder(countyStateName,(nonCovidExcCDRMed2021)),
                            ymin = nonCovidExcCDRLow2021*100, 
                            ymax = nonCovidExcCDRUp2021*100),
                width = 0.3, size = 0.8, color = brewer.pal(5, 'Blues')[5]) +
  scale_y_continuous(labels = comma_format(big.mark = ',',decimal.mark = '.')) + 
  coord_flip(ylim=c(0,300)) +
  labs(x = "", 
       y = "Excess Death Rate Net of COVID (Per 100,000 Person-Years)",
       title = "Highest Excess Death Rate Net of COVID (2021)",
       fill='') +
  theme_minimal()
...
## Fig 4 Bars Bottom 2021

popCutoff <- 100000
nBars <- 20

fig4BarsBottom2021 <- exMortData %>%
  filter(pop2021 > popCutoff) %>%
  slice_min(order_by = nonCovidExcCDRMed2021, n = nBars) %>%
  arrange(desc(nonCovidExcCDRMed2021)) %>%
  select(countyStateName,nonCovidExcCDRMed2021,
         nonCovidExcCDRLow2021,nonCovidExcCDRUp2021) %>%
  ggplot() +
  ...
  labs(x = "", 
       y = "Excess Death Rate Net of COVID (Per 100,000 Person-Years)",
       title = "Lowest Excess Death Rate Net of COVID (2021)",
       fill='') +
  theme_minimal()
...
pdf(here::here('figures','fig4_2020.pdf'),width=10,height = 14)

fig4BarsTop2020/fig4BarsBottom2020 + plot_layout(heights = c(1, 1)) + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig4_2020.png'), width = 2000, height = 3000, res = 300, pointsize=4)
...
pdf(here::here('figures','fig4_2021.pdf'),width=10,height = 14)

fig4BarsTop2021/fig4BarsBottom2021 + plot_layout(heights = c(1, 1)) + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig4_2021.png'), width = 2000, height = 3000, res = 300, pointsize=4)
...
pdf(here::here('figures','fig4.pdf'),width=12,height = 14)

fig4BarsTop2020 + fig4BarsTop2021 + plot_annotation(tag_levels = 'A')
...
png(here::here('figures','fig4.png'), width = 3000, height = 3000, res = 300, pointsize=4)
